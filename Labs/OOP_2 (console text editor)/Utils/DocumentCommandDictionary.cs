using OOP_2__console_text_editor_.Commands.Document.Cursor;
...
public class DocumentCommandDictionary : IDictionary
{
    ...
    public DocumentCommandDictionary(TextEditService _textEditService, CommandProcessor commandProcessor)
    {
    ...
    {
        _commands.Add((ConsoleKey.LeftArrow, 0), () => new MoveCursorLeftCommand(_textEditService)); 
        _commands.Add((ConsoleKey.RightArrow, 0 ), () => new MoveCursorRightCommand(_textEditService)); 
        _commands.Add((ConsoleKey.UpArrow, 0 ), () => new MoveCursorUpCommand(_textEditService)); 
        _commands.Add((ConsoleKey.DownArrow, 0 ), () => new MoveCursorDownCommand(_textEditService)); 
